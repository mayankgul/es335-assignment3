...
# About Section 
with st.expander("ℹ About this App / How it Works", expanded=True):
    st.markdown("""
    This Streamlit app demonstrates **Next-Word Prediction** using a **Multi-Layer Perceptron (MLP)** trained on two datasets:
    - **Shakespeare Texts (Natural Language)**
    - **Linux Kernel Code (Programming Language)**

    **Controls Explanation:**
    - **Dataset:** Choose between Shakespeare or Linux code.
    - **Seed Text:** Starting phrase for prediction.
    - **Number of Words (k):** How many words to generate.
    - **Context Length:** Number of previous words the model considers.
    - **Embedding Dimension:** Size of learned word representations.
    - **Activation Function:** ReLU (fast) or Tanh (smooth).
    - **Temperature:** Controls randomness of output.
        - Lower (0.3–0.7): More deterministic
        - Higher (1.0–2.0): More creative
    - **Random Seed:** Ensures reproducible predictions.

     *Tip:* Use lower temperature for Linux (structured), and higher for Shakespeare (creative)!
    """)
